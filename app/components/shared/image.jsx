...
class Image extends Component {
  ...
  render() {
    const { className, imgUrl, onTouchTap, height } = this.props;
    ...
    const styles = StyleSheet.create({
      ...
      img: {
        ...
        opacity: (imageStatus === 201) ? 1 : 0,
        // TODO: dont use in production http://caniuse.com/#feat=object-fit
        objectFit: 'cover'
      }
    });

    return (
      <div className={ `${css(styles.wrapper)} ${className}` } onTouchTap={ onTouchTap }>
        <img
...
Image.defaultProps = {
  imgUrl: 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==',
  className: '',
  height: '100%'
};
